...
![Language](https://img.shields.io/badge/Language-Python-3776AB?style=flat-square) ![Stars](https://img.shields.io/github/stars/Devanik21/Phising-email?style=flat-square&color=yellow) ![Forks](https://img.shields.io/github/forks/Devanik21/Phising-email?style=flat-square&color=blue) ![Author](https://img.shields.io/badge/Author-Devanik21-black?style=flat-square&logo=github) ![Status](https://img.shields.io/badge/Status-Active-brightgreen?style=flat-square)

> Phising Email — an intelligent, interactive ML application built for real-world prediction and analysis.

---

**Topics:** `python` · `cybersecurity` · `deep-learning` · `email-security` · `machine-learning` · `natural-language-processing` · `neural-networks` · `nlp` · `phishing-detection` · `text-classification`

## Overview

Phising Email is a machine learning web application built on Streamlit that provides a clean, accessible interface for a trained predictive model. The application takes structured user input, preprocesses it through a scikit-learn Pipeline, and returns model predictions with confidence scores and explanatory visualisations.
...
> **Key packages detected in this repo:** `scikit-learn` · `numpy` · `gdown` · `pandas` · `matplotlib` · `seaborn` · `scipy` · `xgboost` · `lightgbm` · `catboost`
...
```bash
git clone https://github.com/Devanik21/Phising-email.git
cd Phising-email
